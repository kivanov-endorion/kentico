...
public partial class BasicRepeaterExport : CMSAbstractWebPart
{
    #region "Variables"
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        ...
        if (PortalContext.ViewMode == ViewModeEnum.LiveSite)
        {
            ...
            ce.ExportData((ExportPage.ExportFormats)ExportFormat, ExportFilename, Page, BasicRepeater.DataSource, PdfOrientation, PdfHeaderLogoPath, html, ContentType, UseTransformation);
        }
        else
        {
            base.Render(writer);
