...
public partial class CMSWebParts_Text_LinkClicktrack : CMSAbstractWebPart
{
    #region "Properties"
    ...
    public string StatisticsName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("StatisticsName"), "");
        }
        set
        {
            this.SetValue("StatisticsName", value);
        }
    }
    ...
    public string ObjectName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("ObjectName"), "");
        }
        set
        {
            this.SetValue("ObjectName", value);
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            Page.Form.Target = btnElem.LinkTarget;
           ...
           // btnElem.OnClientClick = "form.target ='"+LinkTarget+"';";
    ...
    protected void btnElem_Click(object sender, EventArgs e)
    {
        // Gets the name of the current site
        string siteName = SiteContext.CurrentSiteName;

        btnElem.LinkText = StatisticsName;
        ...
        if (AnalyticsHelper.AnalyticsEnabled(siteName))
        {
           ...
           // HitLogProvider.LogHit(StatisticsName.ToString().ToLower(), siteName.ToString(), null, ObjectName.ToString(), 0);
           // HitLogProvider.LogHit("buttonclicked", siteName, null, MembershipContext.AuthenticatedUser.UserName, 0);
            HitLogProvider.LogHit(StatisticsName.ToString().ToLower(), siteName, null, MembershipContext.AuthenticatedUser.UserName, 0);

            ltlDebug.Text = StatisticsName.ToString().ToLower() + " | " + siteName.ToString() + " | " + null + " | " + MembershipContext.AuthenticatedUser.UserName + " | " + "0";
        }

        

        
        Response.Redirect(btnElem.LinkUrl);
