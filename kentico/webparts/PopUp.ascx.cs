...
public partial class PopUp : CMSAbstractWebPart
{
    #region "Properties"
    ...
    public string OKText
    {
      get
      {
        return ValidationHelper.GetString(GetValue("OKText"), "OK");
      }
      set
      {
        SetValue("OKText", value);
      }
    }
    ...
    /// Enables or disables save of OK click in browser.
    /// </summary>
    public string OKClass
    {
      get
      {
        return ValidationHelper.GetString(GetValue("OKClass"), "btn btn-primary");
      }
      set
      {
        SetValue("OKClass", value);
      }
    }
    ...
    public bool SaveSeen
    {
      get
      {
        return ValidationHelper.GetBoolean(GetValue("SaveSeen"), false);
      }
      set
      {
        SetValue("SaveSeen", value);
      }
    }


    /// <summary>
    /// Specifies the key name to store the information.
    /// </summary>
    public string SaveKey
    {
      get
      {
        return CurrentSite.DomainName + " - " + ValidationHelper.GetString(GetValue("SaveKey"), CurrentDocument.RelativeURL) + " - PopUp";
      }
      set
      {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            plcSaveSeen.Visible = SaveSeen;
            plcCheckShow.Visible = SaveSeen;

            HtmlGenericControl btnOK = FindControl("popUpOK") as HtmlGenericControl;
            btnOK.InnerText = OKText;
            btnOK.Attributes["class"] = OKClass;
        }
    }
