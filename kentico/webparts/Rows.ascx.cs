...
public partial class oneIM_CMSWebParts_Layouts_Rows : CMSAbstractLayoutWebPart
{
    #region "Properties"
    ...
    public string myID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("myID"), "");
        }
        set
        {
            SetValue("myID", value);
    ...
    public string Row1ID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Row1ID"), "");
        }
        set
        {
            SetValue("Row1ID", value);
        }
    }
    ...
    public string Row2ID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Row2ID"), "");
        }
        set
        {
            SetValue("Row2ID", value);
        }
    }
    ...
    public string Row3ID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Row3ID"), "");
        }
        set
        {
            SetValue("Row3ID", value);
        }
    }
    ...
    /// First row CSS class.
    /// </summary>
    public string Row4ID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Row4ID"), "");
        }
        set
        {
            SetValue("Row4ID", value);
        }
    }
    ...
    /// First row CSS class.
    /// </summary>
    public string Row5ID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Row5ID"), "");
        }
        set
        {
            SetValue("Row5ID", value);
        }
    }
    #endregion
    ...
    protected override void PrepareLayout()
    {
        ...
        for (int i = 1; i <= Rows; i++)
        {
            ...
            // Cell class
            string globalID = ValidationHelper.GetString(GetValue("myID"), "");

            string thisRowID = ValidationHelper.GetString(GetValue("Row" + i + "ID"), "");
            ...
            else
            {
                ...
                {
                    Append(" id=\"", globalID, "_", rowId, "\" ");

                }else if (!String.IsNullOrEmpty(thisRowID))
                {
                    Append(" id=\"", thisRowID, "\" ");
                }
                else
                {
                    //Append(" id=\"", ShortClientID, "_", rowId, "\" ");
                }
